        ...
        LocationListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LatLng jerico= new LatLng(5.7925, -75.786208);
        MarkerOptions mjerico = new MarkerOptions()
         .position(jerico)
        .title("JERICÓ ANT");
        mMap.addMarker(mjerico);
        mMap.moveCamera(CameraUpdateFactory.newLatLng(jerico));
